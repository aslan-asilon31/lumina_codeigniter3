<img class="wave" src="<?= base_url()?>assets/auth-page/img/wave-purple.svg">
    <div class="container">
        <div class="img">
            <img src="<?= base_url()?>assets/auth-page/img/auth-3d-purple/2.png">
        </div>
        <div class="login-container">
            <form action="<?= site_url('register/process_registration') ?>" method="post">
                <h2>Register Page</h2>
                ...
                <div class="input-div two">
                    ...
                    <div>
                        <input class="input" type="password" name="password-confirm" placeholder="password confirm">
                    </div>
                </div>
                <div class="terms">
                    <input type="checkbox">
